  ...
  return (
    <div className='sm:col-span-1'>
      {isLoading ? (
        ...
        <button
          type='submit'
          className='inline-flex items-center px-5 py-3 mt-4 sm:mt-6 text-sm font-medium text-center text-white dark:bg-[#3681B2]  dark:hover:bg-[#1E658F] rounded-lg focus:ring-4 focus:ring-blue-200 
          bg-[#3681B2] hover:bg-[#1E658F]'
        >
